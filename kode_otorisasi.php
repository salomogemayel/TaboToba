    ...
    <body>
        ...
        <div class="content">
            <div class="container-lg mt-5 mx-auto">
                <h2 class="my-5">Ubah Kode Otorisasi</h2>
                <form action="ubah_kode_otorisasi.php" method="POST" style="max-width: 500px; min-height: 300px;">
                    <div class="mb-3 row">
                        <label for="inputPassword" class="col-sm-5 col-form-label" for="old_authorization_code">Kode Otorisasi Lama:</label>
                        <div class="col-sm-7">
                        <input type="password" class="form-control" id="inputPassword" name="old_authorization_code" required>
                        </div>
                    </div>

                    <div class="mb-3 row">
                        <label for="inputPassword" class="col-sm-5 col-form-label" for="new_authorization_code">Kode Otorisasi Baru:</label>
                        <div class="col-sm-7">
                        <input type="password" class="form-control" id="inputPassword" name="new_authorization_code" required>
                        </div>
                    </div>
                    <br>
                    <input type="submit" class="btn btn-primary" value="Ubah Kode Otorisasi">
                </form>
            </div>
        </div>
