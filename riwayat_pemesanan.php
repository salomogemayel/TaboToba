                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th scope="col"></th> <!-- Added column for order details button -->
                        </tr>
                    </thead>
                    <?php
                    include_once('config/autoload.php');
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        $countOrderItem = $row['item_count'];
                        ?>
                        <tbody>
                            <tr>
                                <th scope="row"><?php echo $number; ?></th> <!-- Display the number -->
                                <td><?php echo $username; ?></td>
                                <td>Rp<?php echo number_format($totalPrice); ?></td>
                                <td><?php echo $orderDate; ?></td>
                                <td><?php echo $countOrderItem; ?></td>
                                <td>
                                    <a href="detail_pemesanan.php?order_id=<?php echo $orderID; ?>" class="btn btn-primary">Lihat Detail Pesanan</a>
                                </td>
                            </tr>
                        </tbody>
                        <?php
