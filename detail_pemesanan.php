        ...
        <div class="content mb-5">
            <div class="container-lg my-5">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="riwayat_pemesanan.php">Riwayat Pemesanan</a></li>
                ...
                if (isset($_GET['order_id'])) {
                    ...
                    if (mysqli_num_rows($orderResult) > 0) {
                        ...
                        if (mysqli_num_rows($userResult) > 0) {
                            ...
                            $itemQuery = "SELECT oi.order_item_id, p.name_product, oi.quantity, p.price_produk 
                                        FROM order_item oi 
                            ...
                            if (mysqli_num_rows($itemResult) > 0) {
                                ...
                                <h5>Pemesan: <?php echo $username; ?></h5>
                                <h5>Tanggal Pemesanan: <?php echo $orderDate; ?></h5>
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th scope="col">No.</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><strong>Rp<?php echo number_format($grandTotal); ?></strong></td>
                                        </tr>
                                    </tbody>
                                </table>
                                <?php
