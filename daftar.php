                            ...
                            <div class="row justify-content-center">
                              ...
                              <div class="col-md-4">
                                <button class="masuk-btn mt-1">
                                  <a href="kelola_akun.php" role="button" style="color: #ffff;">Akun Saya</a>
                                </button>
                              </div>
      ...
      <div class="row">    
        <div class="col-5">
          <div class="container" style="max-width: 400px;">      
            ...
            <div class="row">
              <div class="col-8">
              <h1 class="mt-5">Daftar Akun</h1>
              </div>
              <div class="col-4">
                <div class="text-end mt-5">
                  <button class="masuk-btn">
                    <a href="daftar_admin.php">
                      <i class="fa-solid fa-user-gear fa-lg mx-auto" style="color: #ffff;"></i>
                    </a>
                  </button>
                </div>
              </div>
            </div>  
            <form class="mt-4" action="daftar_process.php" method="POST">
              <div class="mb-3">
