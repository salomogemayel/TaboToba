        ...
        <div class="content mb-5">
            <div class="container-lg my-5" >
                <div class="container mt-4">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Ubah Informasi Alamat</li>
                        </ol>
                    </nav>
                </div>
                <div class="container my-2" style="max-width: 600px;">
                    <h3 class="mb-4 mt-1">Ubah Informasi Alamat</h3>
                <?php
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $updateQuery = "UPDATE alamat SET alamat=?, desa=?, kecamatan=?, `kabupaten/kota`=?, provinsi=?, `kode_pos`=?";
                    $stmt = $conn->prepare($updateQuery);
                    $stmt->bind_param("ssssss", $alamat, $desa, $kecamatan, $kabupaten, $provinsi, $kode_pos);
                
                    if ($stmt->execute()) {
                        echo '<div class="alert alert-success mt-3" role="alert">Perubahan berhasil disimpan.</div>';
                        // Update the address variable after successful update
                        $address['alamat'] = $alamat;
                        $address['desa'] = $desa;
                        $address['kecamatan'] = $kecamatan;
                        $address['kabupaten/kota'] = $kabupaten;
                ...
                ?>
                    ...
                    <form method="post" enctype="multipart/form-data" >
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="exampleFormControlTextarea1" name="alamat" rows="3"><?php echo $address['alamat']; ?></textarea>
                        </div>

                        <div class="row">
                            <div class="col-md-6 mb-3 mt-3">
                                <label for="exampleFormControlInput1" class="form-label">Desa:</label>
                                <input type="text" class="form-control" id="exampleFormControlInput1" name="desa" value="<?php echo $address['desa']; ?>">
                            </div>
                
                            <div class="col-md-6 mb-3 mt-3">
                                <label for="exampleFormControlInput1" class="form-label">Kecamatan:</label>
                                <input type="text" class="form-control" id="exampleFormControlInput1" name="kecamatan" value="<?php echo $address['kecamatan']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="inputCity" name="kabupaten" value="<?php echo $address['kabupaten/kota']; ?>">
                        </div>
                        <div class="col-md-5">
                            <label for="inputCity" class="form-label">Provinsi :</label>
                            <input type="text" class="form-control" id="inputCity" name="provinsi" value="<?php echo $address['provinsi']; ?>">
                        </div>
                          <div class="col-md-3">
                            <label for="inputZip" class="form-label">Kode Pos </label>
                            <input type="text" class="form-control" id="inputZip" name="kode_pos" value="<?php echo $address['kode_pos']; ?>">
                          </div>
                        </div>
